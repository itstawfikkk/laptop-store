...
// تحويل الصورة المرفوعة من الجهاز إلى Base64 وحفظها
...
addLaptopForm.addEventListener('submit', async (e) => {
    ...
    const imageFile = document.getElementById('laptop-image-file').files[0];
...
---
تأكد أيضاً أن واجهة الزبون (`js/app.js` أو الكود المسؤول عن عرض الأجهزة في الصفحة الرئيسية) تقوم بعرض صورة الجهاز باستخدام خاصية `src="${laptop.imageUrl}"` لتظهر الصورة بشكل طبيعي فور إضافتها من جهازك!