...
// عملية تسجيل الدخول مع الانتقال الفوري
...
*(ملاحظة سريعة للتأكد: في صفحة `admin.html` تأكد أن حقل رفع الصورة يحمل الـ ID التالي لكي يستطيع الكود قراءته بنجاح: `<input type="file" id="laptop-image-file" accept="image/*" ...>`)*